...
//Funktion isMouseMoved ist ausgeschaltet
...
function draw() {
  background(0);
  translate(width / 2, height / 2); //0-Punkt in die Mitte gesetzt
  ...
  if (Mikrofon.started) {
    ...
    */ 
    micLevel = Mikrofon.listenMic(); //Wenn Variabel "Mikrofon" gestartet wird hört das mikrofon zu
  ...
  // 3 Arcs die sich gegen den Uhrzeigersinn drehen
  ...
  // Lange Linien und gestrichelte Linien der Sonne
...
//Sobald die Maus gedrückt wird sieht man die Kreise und die Farben ändern sich anhand der Position der Maus.
//Loop gestoppt
...
// Wenn die Maus gelöst wird startet loop wieder
